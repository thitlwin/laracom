					...
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" href="/products">Product 2</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="/product_detail">Single Product 1</a>
								<a class="dropdown-item" href="/product_detail">Single Product 2</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="/checkout">Checkout Page</a>
								<a class="dropdown-item" href="/payment">Payment Page</a>
							</div>
						</li>
						<li class="nav-item">
