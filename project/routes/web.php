...
Route::get('/about', function () {
       return view('updateEcommerce.frontend.about');
    });
Route::get('/contact', function(){
    return view('updateEcommerce.frontend.contact');

});

Route::get('/faq', function(){
    return view('updateEcommerce.frontend.faq');

});

Route::get('/products', function(){
    return view('updateEcommerce.frontend.products.products');

});

Route::get('/product_detail', function(){
    return view('updateEcommerce.frontend.products.product_detail');

});

Route::get('/checkout', function(){
    return view('updateEcommerce.frontend.products.checkout');
